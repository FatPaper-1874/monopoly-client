            ...
            if (time < frames[0]) {
                switch (blend) {
                    case MixBlend.setup:
                        ...
                        return;
                    case MixBlend.first:
                        let light = slot.color, dark = slot.darkColor, setupLight = slot.data.color,
...
(function (spine) {
    class IkConstraint {
        ...
        apply2(parent, child, targetX, targetY, bendDir, stretch, softness, alpha) {
            ...
            let px = parent.ax, py = parent.ay, psx = parent.ascaleX, sx = psx, psy = parent.ascaleY,
                csx = child.ascaleX;
...
(function (spine) {
    class PathConstraint {
        ...
        computeWorldPositions(path, spacesCount, tangents, percentPosition, percentSpacing) {
            ...
            let verticesLength = path.worldVerticesLength, curveCount = verticesLength / 6,
...
(function (spine) {
    class Skeleton {
        ...
        updateCache() {
            ...
            let ikCount = ikConstraints.length, transformCount = transformConstraints.length,
        ...
        getBounds(offset, size, temp = new Array(2)) {
            ...
            let minX = Number.POSITIVE_INFINITY, minY = Number.POSITIVE_INFINITY, maxX = Number.NEGATIVE_INFINITY,
...
(function (spine) {
    class SkeletonClipping {
        ...
        static makeClockwise(polygon) {
            ...
            let area = vertices[verticeslength - 2] * vertices[1] - vertices[0] * vertices[verticeslength - 1], p1x = 0,
                p1y = 0, p2x = 0, p2y = 0;
