...
import { onBeforeMount, computed, ref, onUpdated } from "vue";
import { getUserInfo } from "../utils/api/user";
import { useUserInfo, useUserList, useRoomList, useRoomInfo, useLoading } from "../store/index";
...
onBeforeMount(async () => {
	...
	if (user) {
		socketClient = GameSocketClient.getInstance(user);
	} else {
