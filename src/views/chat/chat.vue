...
<template>
  <div class="chat">
    <button class="chat_show-button" @click="handleChatShow">
      <FontAwesomeIcon icon="comments" style="margin-right: .3rem;"/>
      聊天 <span style="font-size: .8em;">{{
        newMessageNotify
      }}</span>
    </button>
    <div class="chat_main-container">
      <div class="chat_content-container">
        <TransitionGroup name="list">
          <ChatMessageItem v-for="message in chatMessageList" :key="message.user.userId + message.time"
