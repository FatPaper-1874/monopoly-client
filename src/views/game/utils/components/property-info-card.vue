...
<template>
	<div class="property-info" :style="{
		...
		<div class="buildingLevel">
			<span class="label">建筑等级</span><span class="data" :style="{ color: _propertyBuildLevelColor }">{{
				_propertyBuildLevelName }}</span>
		</div>
		<div class="buildCost">
		...
		<div class="owner">
			<span class="label">拥有人</span><span class="data" :style="{ color: _playerNameColor }">{{
